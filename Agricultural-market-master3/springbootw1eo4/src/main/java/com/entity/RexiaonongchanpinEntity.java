...
public class RexiaonongchanpinEntity<T> implements Serializable {
	...
	private java.util.Date reducestarttime;
	private java.util.Date reduceendtime;
	...
	public String getShangjiazhango() {
		return shangjiazhango;
	}
	public void setShangjiazhango(String shangjiazhango) {
		this.shangjiazhango = shangjiazhango;
	}
	...
	public Integer getJifencost() {
		return jifencost;
	}
	public void setJifencost(Integer jifencost) {
		this.jifencost = jifencost;
	}
	...
	public java.util.Date getReducestarttime() { return reducestarttime; }
	public void setReducestarttime(java.util.Date reducestarttime) { this.reducestarttime = reducestarttime; }

	public java.util.Date getReduceendtime() { return reduceendtime; }
	public void setReduceendtime(java.util.Date reduceendtime) { this.reduceendtime = reduceendtime; }

	public Float getReducediscount() { return reducediscount; }
	public void setReducediscount(Float reducediscount) { this.reducediscount = reducediscount; }
}