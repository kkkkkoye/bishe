<template>
	<div class="addEdit-block" :style='{"padding":"0px 3%"}' style="width: 100%;">
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="用户账号" prop="shangjiazhango">
					<el-input v-model="ruleForm.shangjiazhango" placeholder="用户账号" clearable  :readonly="ro.shangjiazhango"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="用户账号" prop="shangjiazhango">
					<el-input v-model="ruleForm.shangjiazhango" placeholder="用户账号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="用户姓名" prop="shangjianame">
					<el-input v-model="ruleForm.shangjianame" placeholder="用户姓名" clearable  :readonly="ro.shangjianame"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="用户姓名" prop="shangjianame">
					<el-input v-model="ruleForm.shangjianame" placeholder="用户姓名" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' class="input" v-if="type!='info'"  label="联系方式" prop="lianxifangshi">
					<el-input v-model="ruleForm.lianxifangshi" placeholder="联系方式" clearable  :readonly="ro.lianxifangshi"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 20px","background":"none","display":"inline-block"}' v-else class="input" label="联系方式" prop="lianxifangshi">
...
export default {
	...
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						if(o=='shangjiazhango'){
							this.ruleForm.shangjiazhango = obj[o];
							this.ro.shangjiazhango = true;
							continue;
						}
						if(o=='mima'){
    ...
    onSubmit() {
      ...
      if((this.ruleForm.shangjiazhango.length<3)){
        this.$message.error(`用户账号长度不能小于3`);
        return
      }
      if((this.ruleForm.shangjiazhango.length>10)){
