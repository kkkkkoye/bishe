<template>
	<div style="height: 100%;">
		...
		<el-main :style='"vertical" == "vertical" ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : {"minHeight":"100%","margin":"0","position":"relative"}'>
			<index-header :style='{"boxShadow":"0 1px 6px rgba(64, 158, 255, .2)","padding":"8px 20px","alignItems":"center","top":"0","left":"0","background":"rgba(184, 222, 74, 1)","display":"flex","width":"100%","position":"fixed","justifyContent":"center","fontWeight":"600","zIndex":"1004"}'></index-header>
			...
			<bread-crumbs :title="title" :style='{"width":"94%","padding":"15px 0","margin":"65px auto 0","borderColor":"rgba(184, 222, 74, 1)","borderStyle":"solid","borderWidth":"0 0 1px 0"}' class="bread-crumbs"></bread-crumbs>
