		...
		<view class="container" :style='{"width":"100%","padding":"0","position":"relative","background":"url(http://codegen.caihongy.cn/20221108/581bb1956ffe4c8182127ca1e196e95e.png) fixed","height":"auto"}'>
            <view :style='{"width":"100%","padding":"24rpx","background":"none","height":"auto"}' class="detail-content">
				...
				<view class="detail-list-item" :style='{"boxShadow":"0px 0.10rpx 4rpx #ccc","padding":"16rpx 20rpx","margin":"0 0 16rpx 0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"radial-gradient(circle, rgba(255,255,255,1) 0%, rgba(246,246,246,1) 100%)","display":"block","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>关联表id：</view>
				...
				<view class="detail-list-item" :style='{"boxShadow":"0px 0.10rpx 4rpx #ccc","padding":"16rpx 20rpx","margin":"0 0 16rpx 0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"radial-gradient(circle, rgba(255,255,255,1) 0%, rgba(246,246,246,1) 100%)","display":"block","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>用户名：</view>
					<view  class="text" :style='{"width":"100%","padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.nickname}}</view>
				</view>



				<view class="detail-list-item" :style='{"boxShadow":"0px 0.10rpx 4rpx #ccc","padding":"16rpx 20rpx","margin":"0 0 16rpx 0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"radial-gradient(circle, rgba(255,255,255,1) 0%, rgba(246,246,246,1) 100%)","display":"block","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>评论内容</view>
					<view class="text" :style='{"width":"100%","padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.content}}</view>
				</view>
				<view class="detail-list-item" :style='{"boxShadow":"0px 0.10rpx 4rpx #ccc","padding":"16rpx 20rpx","margin":"0 0 16rpx 0","borderColor":"#ccc","borderWidth":"0 0 2rpx 0","background":"radial-gradient(circle, rgba(255,255,255,1) 0%, rgba(246,246,246,1) 100%)","display":"block","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","color":"#333","textAlign":"left","width":"100%","lineHeight":"48rpx","fontSize":"28rpx","fontWeight":"600"}'>回复内容</view>
					<view class="text" :style='{"width":"100%","padding":"0px","margin":"0px","lineHeight":"48rpx","fontSize":"28rpx","color":"rgb(0, 0, 0)"}'>{{detail.reply}}</view>
				</view>
...
<script>
	export default {
		...
		async onShow(options) {
			...
			let cleanType = uni.getStorageSync('discussdiscussrexiaonongchanpinCleanType')
			if(cleanType){
				uni.removeStorageSync('discussdiscussrexiaonongchanpinCleanType')
				this.mescroll.num = 1
		...
		methods: {
			// 支付
			onPayTap(){
				uni.setStorageSync('paytable','discussrexiaonongchanpin');
			...
			onAcrossTap(tableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
				uni.setStorageSync('crossTable','discussrexiaonongchanpin');
			...
			// 获取详情
			async init(){
				let res = await this.$api.info('discussrexiaonongchanpin', this.id);
			...
			async upCallback(mescroll) {
                let res = await this.$api.list('discussdiscussrexiaonongchanpin', {
					page: mescroll.num,
					limit: 10,
					refid: this.id
				});
			...
			// 添加评论
			async onCommentTap() {
				this.$utils.jump(`../discussdiscussrexiaonongchanpin/add-or-update?refid=${this.id}`)
			},
			onSHTap() {
